...
function preload() {
  top_image = loadImage("images/top.jpg");
  side_image = loadImage("images/side.jpg");
  PCB_image = loadImage("images/PCB 2.jpg");
  torquer_image = loadImage("images/copper 2.jpg");
  interior_image = loadImage("images/capton 2.jpg");
}
